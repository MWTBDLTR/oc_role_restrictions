...
(function () {
    ...
    function setupMutationObserver(root) {
        const observer = new MutationObserver(() => {
            ...
            const tabTitle = document.querySelector('button[class*="active___"] span[class*="tabName___"]')?.textContent.trim();
    ...
    function findCrimesRoot() {
        ...
        if (!root) {
            ...
            root = document.querySelector('#faction-crimes-root, #faction-tab-container, .crimes-wrapper');
        }
